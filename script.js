...
inputcontainer.innerHTML = `<input type="text" id ="name" placeholder="Enter Your Name" oninput="storename(event)">
<button id="button" onclick= "searchnation()">FIND NATIONALITY</button>`
...
searchContainer.innerHTML= `<div class="display1">`
function displaydata(obj){
    ...
    searchContainer.innerHTML=``;
     for(var x=0;x<2;x++){
        ...
        resultcontainer.innerHTML=`<h6>COUNTRY:</h6>${countryid[obj.country[x].country_id]}
        <h6>PROBABILITY:</h6>${obj.country[x].probability}`
